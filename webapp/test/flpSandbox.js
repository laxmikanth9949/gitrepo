		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "git reporitory first project",
									"targetURL": "#comsamplegitrepo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsamplegitrepo-display": {
								"semanticObject": "comsamplegitrepo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sample.gitrepo",
									"url": sap.ui.require.toUrl("com/sample/gitrepo")
								}
							}
						}
					}
